...
class FunCog(commands.Cog):
    ...
    @app_commands.command(
        name="accentcolour", description="Get the accent colour of a user's avatar"
    )
    @app_commands.describe(user="The user to get the accent colour from (optional)")
    async def accentcolour(
